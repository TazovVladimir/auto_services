...
<head>
    ...
    <title>Auto service Наши услуги</title>
</head>
...
<body>
    <header>
        ...
        <ul class="nav">
            ...
            <a href="/src/pages/services.php" class="nav_a nav_a_active">
                <li class="nav_item">
                ...
                <ul class="services">
                    ...
                    while ($info = mysqli_fetch_assoc($services)) {
                        ...
                        <li class="services_item">
                            <?php echo '<img class="services_item_img" src="data:image/png;base64,'.base64_encode( $info['img'] ).'"/>'; ?>
                            <span class="service_price">
                                <?php echo $info['price']; ?> р
                            </span>
                            <ul class="services_item_par">
                                <li class="title">
                                    <?php echo $info['title']; ?>
                                </li>
                                <li class="par_about">
                                ...
                                <li class="btn_services"><a href="/src/pages/request.php">Оставить заявку</a></li>
                            </ul>
                        </li>
                        <?php
                    }
